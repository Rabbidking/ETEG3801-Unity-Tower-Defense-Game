...
public class NavMeshGen : MonoBehaviour
{
	...
	void Start()
    {
		...
		//Spawner spawn = Instantiate(Spawner, mg.StartPos, Quaternion.identity);
		//spawn.Startpos = mg.StartPos;
		//spawn.Endpos = mg.EndPos;

  //      endPoint.transform.position = mg.EndPos + Vector3.up;
